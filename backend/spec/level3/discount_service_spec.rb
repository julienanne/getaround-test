require_relative "../../level3/discount_service"
  ...
  context "can calculate discount to rental" do
    describe "call" do
      it "only one day no discount" do
        ...
        discount_service = DiscountService.new(rental)

        expect(discount_service.call).to eq(0)
      end
      ...
      it "price per day decreases by 10\% after 1 day" do
        ...
        expect(discount_service.call).to eq(200)
      end
      ...
      it "price per day decreases by 30\% after 4 days" do
        ...
        expect(discount_service.call).to eq(1200)
      end
      ...
      it "price per day decreases by 50\% after 10 days" do
        ...
        expect(discount_service.call).to eq(6200)
      end
    end
  end
end
